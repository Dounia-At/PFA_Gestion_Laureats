    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnonceTechnologies", x => new { x.AnnonceId, x.TechnologieId });
                    table.ForeignKey(
                        name: "FK_AnnonceTechnologies_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnonceTechnologies_Technologie_TechnologieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnonceTechnologies_TechnologieId",
                table: "AnnonceTechnologies",
